## Chapter 38 — Death Defeated, Life Restored  
### Closing Summary
...
What is frequently affirmed in theory is rarely followed through **concretely**. Death is acknowledged, but not located. Participation is affirmed, but not enacted. Resurrection is proclaimed, but the passage through death that makes resurrection real is softened into metaphor.

This book has pressed that unresolved question to its conclusion.
...
This does not diminish grace. It reveals its power.  
Grace does not merely excuse. It **liberates**.  
Grace does not merely declare. It **transforms**.  
Grace does not leave the old life intact. It brings it to an end.

Death has been defeated, not by denial, but by participation.  
Life has been restored, not by abstraction, but by resurrection.

The gospel the apostles preached was not a message about managing sin while remaining alive to the old world. It was a proclamation that a new world has begun, and that entrance into it requires leaving the old one behind.

That passage has a shape.  
It has a moment.  
It has a name.
...
The question before the Church is no longer whether this vision is demanding.

The question is whether it is the gospel that was first preached.
